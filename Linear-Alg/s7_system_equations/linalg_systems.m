...
plot3(s(1,1),s(2,1),s(3,1),'ko','markerfacecolor','w','markersize',12)
l = find(abs(s(1,:)-s(1,1))>1,1);
plot3(s(1,l),s(2,l),s(3,l),'ko','markerfacecolor','w','markersize',12)

% parametic solution
%alpha = rand;
%alpha*X*s(:,1) + (1-alpha)*X*s(:,l)
